...
public class P1Tester {
	...
	public static String[] queriesCiteseer = { "shortest path algorithm", "support vector machine", "random forest",
			"convolutional neural networks", "jesus", "mahidol", "chulalongkorn", "thailand",
			"polar bears penguins tigers", "algorithm search engine", "innovative product design social media",
